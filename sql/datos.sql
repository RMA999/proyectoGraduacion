...
INSERT INTO `documentos` (`id`, `id_tipo_documento`, `id_persona_vendedor`, `id_persona_comprador`, `id_persona_declarador`, `id_persona_donatario`, `id_persona_donador`, `id_persona_cedente`, `id_persona_cesionario`, `fecha`, `fecha_escaneado`, `numero_escritura`, `ubicacion_fisica`, `url_archivo`) VALUES
