                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="idInputNombreVendedor" value="<?php echo $vendedor['nombre'] ?>" readonly>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="idInputNombreComprador" value="<?php echo $comprador['nombre'] ?>" readonly>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="idInputDpiVendedor" value="<?php echo $vendedor['dpi'] ?>" readonly>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="idInputDpiComprador" value="<?php echo $comprador['dpi'] ?>" readonly>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="idInputNumEscritura" value="<?php echo $documento['numero_escritura'] ?>" onkeyup="validarNumeroEscritura(this.value)" readonly>
