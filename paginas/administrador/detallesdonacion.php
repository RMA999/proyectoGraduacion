                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="idInputNombreDonante" value="<?php echo $donador['nombre'] ?>" readonly>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="idInputNombreDonatario" value="<?php echo $donatario['nombre'] ?>" readonly>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="idInputDpiDonante" onkeyup="validarDpi(this)" value="<?php echo $donador['dpi'] ?>" readonly>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="idInputDpiDonatario" onkeyup="validarDpi(this)" value="<?php echo $donatario['dpi'] ?>" readonly>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="idInputNumEscritura" onkeyup="validarNumeroEscritura(this.value)" value="<?php echo $documento['numero_escritura'] ?>" readonly>
                            ...
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="idInputUbicacionFisica" rows="3" readonly><?php echo $documento['ubicacion_fisica'] ?></textarea>
                                </div>
                            </div>
